...
echo ""
echo "  3. Fill in .env (BOT_NAME, GATEWAY_PORT, etc.) — no OpenAI tokens needed yet"
echo "  4. Run: bash setup.sh"
echo "  5. After setup.sh completes, run: openclaw models auth login --provider openai"
echo "     (to complete OpenAI OAuth interactively)"
echo ""
